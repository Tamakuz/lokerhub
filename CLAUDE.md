...
Use Jovan Panji Pratama <jovangithub@gmail.com> as the author for future commits unless the user explicitly requests a different author.

Use `git commit --author="Jovan Panji Pratama <jovangithub@gmail.com>"` when committing.
